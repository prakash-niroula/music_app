...
export const LoginScreen: FC = () => {
  return (
    <View className="flex items-center w-full pt-[15%]">
      ...
      <View className="flex space-y-base mt-6 w-full px-5 sm:space-y-3 md:space-y-4">
        <TouchableOpacity className="bg-rectangle-grey w-full sm:h-14 md:h-16 h-rect flex justify-center rounded items-center">
        ...
        <TouchableOpacity className="bg-rectangle-grey w-full sm:h-14 md:h-16 lg:h-20 px-3 h-rect flex justify-center rounded items-center">
          <View className="flex flex-row space-x-2 items-center">
      ...
      <View className="mt-small flex w-full items-center px-5 space-y-small sm:space-y-2 md:space-y-3">
        ...
        <TouchableOpacity className="bg-main-blue w-full sm:h-14 md:h-16 lg:h-20 px-3 h-rect flex justify-center rounded items-center mt-0">
